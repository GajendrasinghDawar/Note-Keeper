...
export default function Header() {
    return (
        <header className=" border-b border-yellow-yellow5 sticky top-0  backdrop-blur-lg bg-gradient-to-r from-yellow-yellow3/50  from-600% z-50  to-yellow-yellow2/50">
